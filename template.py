...
list_of_files = [
    ...
    "access_keys/.gitkeep",  # Placeholder for artifacts directory
    "logs/.gitkeep",  # Placeholder for artifacts directory
    "notebooks_and_research/.gitkeep",  # Placeholder for artifacts directory
]
